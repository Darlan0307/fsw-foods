  ...
  return (
    <div className="mb-10">
      <div className="md:flex md:justify-center md:p-10">
        ...
        />
        <div className="w-full md:max-w-[400px]  md:p-5">
          ...
          <div className="mt-3 flex gap-4 overflow-x-scroll px-5 sm:justify-center md:flex-wrap [&::-webkit-scrollbar]:hidden">
      ...
      <div className="mt-6 space-y-4 md:mt-0">
        ...
        <h2 className="px-5  font-semibold md:text-2xl lg:pl-10">
          Mais Pedidos
        </h2>
